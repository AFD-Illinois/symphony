...
def alpha_I_spline(nu,
    ...
    chi_11 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 0, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 11) 
    chi_22 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 0, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 22)
    chi_13 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 0, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 13)
    chi_33 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 0, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 33)
...
def alpha_V_spline(nu,
    ...
    chi_12 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 1, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 12)
    chi_32 = chi_ij(nu, magnetic_field, electron_density, observer_angle,
                    distribution, 1, theta_e, power_law_p,
                    gamma_min, gamma_max, gamma_cutoff, kappa,
                    kappa_width, 32)

    prefactor = 4. * np.pi * epsilon0 * omega / c
    chi_term  = (chi_12 * np.cos(observer_angle) - chi_32 * np.sin(observer_angle))
    ans       = prefactor * chi_term
